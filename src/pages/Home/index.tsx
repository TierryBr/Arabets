...
function Home() {
  return (
    <>
      ...
      <S.Sociais>
        <S.SocialItemImg color="30A8DE" href='https://t.me/arabetsfutebol' target='_blank'>
          <TelegramLogo size="50" weight="fill"/>
        </S.SocialItemImg>
        <S.SocialItemImg color="33801B" href='https://arabets.com.br/mini-curso-gratis/' target='_blank'>
          <UserCirclePlus size="50" weight="fill"/>
        </S.SocialItemImg>
        <S.SocialItemImg color="C43230" href='https://www.youtube.com/channel/UCd8wp_6XTZ9Do1Ua0INSvZg?app=desktop' target='_blank'>
          <YoutubeLogo size="50" weight="fill"/>
        </S.SocialItemImg>
        <S.SocialItemImg color="D54B77" href='https://www.instagram.com/arabets_corner/?utm_medium=copy_link' target='_blank'>
      ...
      <S.Info>
        <S.InfoDetails>
          <S.InfoDetailsContainer>
            <S.InfoDetailsTitle>ACESSE NOSSO MINICURSO GRATUITO</S.InfoDetailsTitle>
            <S.InfoDetailsSubTitle>E APRENDA A</S.InfoDetailsSubTitle>
          </S.InfoDetailsContainer>
          <S.InfoDetailsDescription>
            <ul >
              <S.ItemLI>A CRIAR UMA CONTA NA BET 365 (ATUALIZADO 2022);</S.ItemLI>
              <S.ItemLI>A TER UM MINDSET VENCEDOR;</S.ItemLI>
              <S.ItemLI>DOIS MÉTODOS QUE VÃO TE AJUDAR A GANHAR DINHEIRO HOJE;</S.ItemLI>
              <S.ItemLI>A COMO TER UMA RENDA EXTRA CONSTANTEMENTE E ESCALONÁVEL;</S.ItemLI>
      ...
      <S.InfoDetails>
          <S.InfoDetailsContainer>
            <S.InfoDetailsTitle>ENTRE PARA NOSSO GRUPO DO TELEGRAM</S.InfoDetailsTitle>
